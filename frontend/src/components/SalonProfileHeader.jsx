      ...
      <div className="mt-8 ml-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-x-4">
            <h2 className="text-2xl font-semibold text-zinc-800">{salon.name}</h2>
            <span className="text-xl font-semibold text-zinc-800">
              {salon.rating} ⭐
            </span>
          </div>
          <button className="flex items-center justify-center w-10 h-10 active:bg-red-200 text-gray-400 hover:text-red-500 transition mr-8">
        ...
        <address className="mt-1 text-stone-500 not-italic">{salon.location}</address>
      </div>
