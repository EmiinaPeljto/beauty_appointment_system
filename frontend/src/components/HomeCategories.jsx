        ...
        <div className="container mx-auto text-center">
          ...
          <h3 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl mt-4">
            <span className="text-[#FF66B2] mt-12">
              From facials to full glam—browse and book in minutes.{" "}
            </span>
          </h3>
          <p className="mt-5 text-lg text-gray-600">
            Find the right treatment for every occasion. Whether you're getting
            ready for a special event or just indulging in some self-care,
            explore our curated categories to book exactly what you need.
          </p>
        </div>
      </header>
    </div>
